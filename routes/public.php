...
Route::get('/eventi', [EventListController::class, 'index'])->name('events.index');
Route::get('/eventi/oggi', [EventListController::class, 'today'])->name('events.today');
Route::get('/eventi/domani', [EventListController::class, 'tomorrow'])->name('events.tomorrow');
Route::get('/eventi/weekend', [EventListController::class, 'weekend'])->name('events.weekend');
Route::get('/eventi/gratis', [EventListController::class, 'free'])->name('events.free');
Route::get('/eventi/categoria/{category}', [EventListController::class, 'category'])->name('events.category');
Route::get('/eventi/tag/{tag}', [EventListController::class, 'tag'])->name('events.tag');
...
Route::get('/locali', [VenueController::class, 'index'])->name('venues.index');
...
Route::get('/locali/{slug}', [VenueController::class, 'show'])->name('venues.show');
