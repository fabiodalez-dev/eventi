{{--
    ...
    **Perché non usa più `x-section-heading`.** Lo faceva, e il risultato era
    ...
    la numerazione che queste due non possono avere: arrivano dopo il primo
    disegno, quando i numeri delle altre sono già stampati, e rinumerare a
    pagina caricata sposterebbe le voci sotto gli occhi di chi legge.
