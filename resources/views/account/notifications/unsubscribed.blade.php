...
<x-layouts.app :narrow="true" :meta="$meta">
    <div class="mx-auto flex w-full max-w-xl flex-col gap-4">
        ...
        <a class="ui-action self-start bg-surface px-4 py-2.5 text-sm font-semibold text-ink border-2 border-line transition hover:border-accent" href="{{ $preferencesUrl }}">
