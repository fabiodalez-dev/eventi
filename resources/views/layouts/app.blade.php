...
<body class="min-h-dvh bg-canvas text-ink antialiased pb-[calc(4rem+env(safe-area-inset-bottom))] lg:pb-0">
    ...
    <main id="contenuto" class="pt-header">
        ...
        @endif
        @if ($city !== null && request()->routeIs('home', 'events.index', 'events.show', 'venues.*', 'search', 'categories.*', 'tags.*', 'city.home', 'city.events.index', 'city.events.show', 'city.venues.*', 'city.search', 'city.categories.*', 'city.tags.*'))
