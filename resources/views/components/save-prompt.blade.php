...
@guest
    <aside
        ...
        class="fixed inset-x-3 bottom-3 z-40 mx-auto max-w-md bg-canvas p-card border-2 border-line"
    >
        ...
        <div class="mt-3 flex flex-wrap items-center gap-2">
            <a
                ...
                class="bg-brand px-3.5 py-2 text-sm font-semibold text-on-brand transition hover:bg-brand-strong"
            >
            ...
            <button
                ...
                class="px-3.5 py-2 text-sm font-semibold text-ink-muted transition hover:text-ink"
            >
