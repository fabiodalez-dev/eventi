...
<x-layouts.app :meta="$meta">
    ...
    <form method="GET" action="{{ route('venues.index') }}" data-venue-filters class="mt-6 venue-grid grid gap-4 md:gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <x-field
            name="q"
    ...
    <div data-venue-results aria-live="polite" aria-busy="false">
        @if ($venues->total() > 0)
            ...
            <div class="mt-3 venue-grid grid gap-4 md:gap-6 sm:grid-cols-2 lg:grid-cols-4">
