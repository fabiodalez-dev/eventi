...
/**
 * Le tabelle di `spatie/laravel-schedule-monitor`, pubblicate come le genera il
 * pacchetto (D13) con due sole differenze: classe anonima invece della classe
 * nominata dello stub — che è ferma alla convenzione di Laravel 5 e collide con
 * qualunque altra migration omonima — e un `down()`, che lo stub non ha e senza
 * il quale un rollback si ferma qui.
 */
