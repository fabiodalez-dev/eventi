...
use App\Jobs\Media\ProcessImageMedia;
use App\Support\Media\CdnUrlGenerator;
...
return [
     ...
     */
    'max_file_size' => 1024 * 1024 * 12, // 12MB (§12.1)
     ...
     */
    'url_generator' => CdnUrlGenerator::class,
     ...
     */
    'jobs' => [
        'perform_conversions' => ProcessImageMedia::class,
