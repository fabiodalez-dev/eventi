...
return [
    ...
    'repositories' => [
        'database' => [
            ...
            'model' => null,
            /*
             * **`system_settings` e non `settings`.**
             *
             * La tabella `settings` in questo progetto esiste gia' ed e' un
             * altro mestiere: chiave/valore tipizzato per i feature flag,
             * prevista dal piano (§ tabelle). Lasciare a questo pacchetto il
             * nome predefinito significherebbe che la sua migrazione tenta di
             * creare una tabella che c'e' — e se anche passasse, due sistemi
             * scriverebbero nello stesso posto con due formati diversi.
             *
             * Qui dentro vivono i gruppi TIPIZZATI, con proprieta' dichiarate
             * e cifratura a riposo: la configurazione della posta e' il primo.
             */
