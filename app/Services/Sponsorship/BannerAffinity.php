...
final class BannerAffinity
{
    ...
    public function apply(Collection $campaigns, City $city, ?User $user, array $context): Collection
    {
        ...
        return $campaigns->map(function (Sponsorship $campaign) use ($venues, $categories, $tags, $events, $savedCategories, $context): Sponsorship {
            ...
            $weighted->weight = max(1, (int) $campaign->weight) * $multiplier;
